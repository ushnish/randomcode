	...
	JTetris(int pixels) {
		...
		*/
		...
		registerKeyboardAction(
			...
			}, "rotate", KeyStroke.getKeyStroke('7'), WHEN_IN_FOCUSED_WINDOW
		);
		registerKeyboardAction(
			new ActionListener() {
				public void actionPerformed(ActionEvent e) {
		...
		registerKeyboardAction(
			...
			}, "rotate", KeyStroke.getKeyStroke('9'), WHEN_IN_FOCUSED_WINDOW
		);
		registerKeyboardAction(
			new ActionListener() {
				public void actionPerformed(ActionEvent e) {
			...
			}, "rotate", KeyStroke.getKeyStroke('p'), WHEN_IN_FOCUSED_WINDOW
		);
		...
		registerKeyboardAction(
			...
			}, "drop", KeyStroke.getKeyStroke('5'), WHEN_IN_FOCUSED_WINDOW
		);
		registerKeyboardAction(
			new ActionListener() {
				public void actionPerformed(ActionEvent e) {
	...
	*/
	public void computeNewPosition(int verb) {
		...
		switch (verb) {
			...
			case ROTATE1:
				newPiece = newPiece.fastRotation1();
				...
				break;
			case ROTATE2:
				newPiece = newPiece.fastRotation2();
	...
	public static final int ROTATE1 = 0;
	public static final int ROTATE2 = 5;
